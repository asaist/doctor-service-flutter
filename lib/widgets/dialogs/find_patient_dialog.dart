...
class FindPatientDialog extends StatefulWidget {
  const FindPatientDialog({super.key});

  @override
  FindPatientDialogState createState() => FindPatientDialogState();
}

class FindPatientDialogState extends State<FindPatientDialog> {
  @override
                  ...
                  () {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return const SelectPatientDialog();
                      },
                    );
                  },
                ),
